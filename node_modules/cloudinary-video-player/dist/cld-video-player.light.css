...
.cld-video-player.vjs-ad-playing .vjs-play-control.vjs-paused, .cld-video-player.vjs-ad-playing .vjs-volume-level {
...
.cld-video-player.cld-video-player-skin-light .vjs-title-bar .vjs-title-bar-title:not(:empty) + .vjs-title-bar-subtitle:not(:empty):before {
  content: "•";
  padding: 0 0.45em;
  font-size: 1.4em;
  font-weight: 500;
...
.cld-video-player .vjs-subs-caps-button .vjs-texttrack-settings {
  display: none;
}
...
.vjs-control-bar a.vjs-control.vjs-cloudinary-button {
  background-image: url(fonts/cloudinary_icon_for_black_bg.svg);
...
.video-js .vjs-volume-panel-horizontal .vjs-volume-level:before, .video-js .vjs-volume-panel-horizontal .vjs-volume-control:before {
  content: "";
  font-size: 20px;
  position: absolute;
  top: 0;
